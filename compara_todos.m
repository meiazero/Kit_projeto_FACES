...
disp("\nMédia, Minimo, maximo, mediana, desvio padrão")
disp(["linearMQ: " num2str(linearMQModel(1)) "," num2str(linearMQModel(2)) "," num2str(linearMQModel(3)) "," num2str(linearMQModel(4)) "," num2str(linearMQModel(5))])
disp(["PSLog: " num2str(pslogModel(1)) "," num2str(pslogModel(2)) "," num2str(pslogModel(3)) "," num2str(pslogModel(4)) "," num2str(pslogModel(5))])
disp(["MLP1h: " num2str(mpl1hModel(1)) "," num2str(mpl1hModel(2)) "," num2str(mpl1hModel(3)) "," num2str(mpl1hModel(4)) "," num2str(mpl1hModel(5))])
disp(["MLP2h: " num2str(mlp2hModel(1)) "," num2str(mlp2hModel(2)) "," num2str(mlp2hModel(3)) "," num2str(mlp2hModel(4)) "," num2str(mlp2hModel(5))])
